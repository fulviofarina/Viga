...
double Euler(double x, double v, double d, double t, double (*f)(double, double, double, double (*)(double, void *), void *), double (*forced)(double, void *), void *arg) //algoritmo runge-kutta 4to orden
{
	return d * f(x, v, t, forced, arg);
}
